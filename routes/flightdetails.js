    ...
    try {
        ...
        if (req.body != null) {
            ...
            getbinarytoken(token).then(function (binarytoken) {
                ...
                const { airline, flightno, depdate, flightorigin } = req.body;

                const add = require("../modules/getflightdetails.js")

                add(airline, flightno, depdate, flightorigin, jsonObject.binarytoken, (err, result) => {
